...
export default function ElementSettings({registryId, channelId, seriesId, elementKey, element, config, onPatchElement}: Props) {
    switch (registryId) {
        case 'widget:pick2':
        ...
        case 'frame:static':
            return <FrameSettings elementKey={elementKey} element={element} onPatchElement={onPatchElement}/>
        case 'resultsThin':
